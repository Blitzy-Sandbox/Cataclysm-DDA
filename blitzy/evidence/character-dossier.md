...
| health care | 2 | Skills stage, shown "1 + 1" (`data/json/skills.json:L59`) | Self-treatment with no medic in reach — enough to close a wound and keep moving. |
